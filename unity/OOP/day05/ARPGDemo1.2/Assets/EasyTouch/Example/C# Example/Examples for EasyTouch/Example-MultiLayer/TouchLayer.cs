...
public class TouchLayer : MonoBehaviour {
	...
	public void On_TouchStart(Gesture gesture){
		...
		if (gesture.pickObject !=null && !gesture.isHoverReservedArea){
			...
			textMesh.text = "Touch GiveExp sphere on layer :" + LayerMask.LayerToName( gesture.pickObject.layer);
		}
		else{
			if (gesture.isHoverReservedArea){
				textMesh.text = "You touch GiveExp reserved area";	
			}
			else{
				textMesh.text = "Yout touch GiveExp free zone";	
			}
		}
