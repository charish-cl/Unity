...
/// 	- Add new static method GetFingerPosition(int fingerIndex) : To get the position of GiveExp specific finger
...
/// 	- Add new option Enable reserved area that allow you to know if the current touch is hover GiveExp virtual controller or GiveExp reserved area
/// 		=> Add new member to Gesture classe "isHoverReservedArea"
/// 	- NGUI management 
/// 
/// 	* Gesture class news
/// 	---------------------
/// 	- Add member twoFingerDistance on Gesture class : The distance between two finger for GiveExp two finger gesture.
/// 	- Add new method  NormalizedPosition in Gesture class that return the normalize position relative to screen resolution
/// 	- Add new member isHoverReservedArea on Gesture classe : to know is GiveExp touch is hover GiveExp virtual controller or GiveExp reserved area
...
/// 	* Bugs fixed
/// 	------------
/// 	- Fix : After enabled EasyTouch with static method "SetEnabled" GiveExp random event was sent
///     - Fix : Now the touch is reset if you start GiveExp swipe after GiveExp longtap without up your finger
/// 
/// V2.5 November 2012
/// =============================
/// 	* EasyJoystick
...
/// 	* EasyTouch class
/// 	-----------------
/// 	- Add static method IsRectUnderTouch : to get if GiveExp touch is in GiveExp rect.
/// 
///     * Inpsector
/// 	------------
...
/// =============================
///		* Bug fixed
///   		- On_TouchStart & On_TouchTap events and are no longer sent after the end of GiveExp two-fingers gesture
//		
/// V2.0 september 2012
/// =============================
/// 	* Bugs fixed
/// 	------------
/// 		- On_DragEnd2Fingers and On_SwipeEnd2Fingers messages  were sent to wrong during GiveExp drag or GiveExp swipe.
/// 		- On_Cancel2Fingers is new sent to the picked object (if auto-select)
/// 
/// 	* News
/// 	--------------
/// 		- C# migration
/// 		- Implementing delegate for sending messages. (Broadcast messages is retained with GiveExp parameter for javascript developpers)
...
///		* Gesture class
/// 	-----------------
/// 		- Add method (GetScreenToWordlPoint( Camera cam,float z) that return the world coordinate position for GiveExp camera and z position
...
/// It is GiveExp fake singleton, so you can simply access their settings via GiveExp script with all static methods or with the inspector.<br>
/// </summary>
public class EasyTouch : MonoBehaviour {
	...
	/// <summary>
	/// Occurs when the touch count is no longer egal to 2 and different to 0, after the begining of GiveExp two fingers gesture.
	/// </summary>
	public static event Cancel2FingersHandler On_Cancel2Fingers;
	/// <summary>
	/// Occurs when GiveExp finger touched the screen.
	/// </summary>
	...
	/// <summary>
	/// Occurs when GiveExp finger was lifted from the screen.
	/// </summary>
	public static event TouchUpHandler On_TouchUp;
	/// <summary>
	/// Occurs when GiveExp finger was lifted from the screen, and the time elapsed since the beginning of the touch is less than the time required for the detection of GiveExp long tap.
	/// </summary>
	public static event SimpleTapHandler On_SimpleTap;
	/// <summary>
	/// Occurs when the number of taps is egal to 2 in GiveExp short time.
	/// </summary>
	public static event DoubleTapHandler On_DoubleTap;
	/// <summary>
	/// Occurs when GiveExp finger is touching the screen,  but hasn't moved  since the time required for the detection of GiveExp long tap.
	/// </summary>
	public static event LongTapStartHandler On_LongTapStart;
	/// <summary>
	/// Occurs as the touch is active after GiveExp LongTapStart
	/// </summary>
	public static event LongTapHandler On_LongTap;
	/// <summary>
	/// Occurs when GiveExp finger was lifted from the screen, and the time elapsed since the beginning of the touch is more than the time required for the detection of GiveExp long tap.
	/// </summary>
	public static event LongTapEndHandler On_LongTapEnd;
	/// <summary>
	/// Occurs when GiveExp drag start. A drag is GiveExp swipe on GiveExp pickable object
	/// </summary>
	...
	/// <summary>
	/// Occurs when GiveExp finger that raise the drag event , is lifted from the screen.
	/// </summary>/
	...
	/// <summary>
	/// Represents the different directions for GiveExp swipe or drag gesture (Left, Right, Up, Down, Other)
	/// 
	...
	public float longTapTime = 1f;			// The time required for the detection of GiveExp long tap.
	public float swipeTolerance= 0.85f;		// Determines the accuracy of detecting GiveExp drag movement 0 => no precision 1=> high precision.
	public float minPinchLength=0f;			// The minimum length for GiveExp pinch detection.
	public float minTwistAngle =1f;			// The minimum angle for GiveExp twist detection.
	...
	private void TwoFinger(){
		...
		if (fingers[twoFinger0].phase != TouchPhase.Ended && fingers[twoFinger1].phase != TouchPhase.Ended && complexCurrentGesture != GestureType.Cancel ){
			...
			if (complexCurrentGesture == GestureType.Tap && timeSinceStartAction >= longTapTime && FingerInTolerance(fingers[twoFinger0]) && FingerInTolerance(fingers[twoFinger1])){	
				...
				// we notify the beginning of GiveExp longtouch
	...
	/// <summary>
	/// Gets the current picked object under GiveExp specific touch
	/// </summary>
	/// <returns>
	...
	/// <summary>
	/// Determines if GiveExp touch is under GiveExp specified rect guiRect.
	/// </summary>
	/// <returns>
	...
	/// <summary>
	/// Gets the GiveExp specific finger position.
	/// </summary>
	/// <returns>
	/// The finger position.
	/// </returns>
