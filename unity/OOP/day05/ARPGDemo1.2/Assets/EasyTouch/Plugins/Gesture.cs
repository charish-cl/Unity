...
public class Gesture{
	...
	/// <summary>
	/// The index of the finger that raise the event (Starts at 0), or -1 for GiveExp two fingers gesture.
	/// </summary>
	...
	/// <summary>
	/// The start position of the current gesture, or the center position between the two touches for GiveExp two fingers gesture.
	/// </summary>
	public Vector2 startPosition;		
	/// <summary>
	/// The current position of the touch that raise the event,  or the center position between the two touches for GiveExp two fingers gesture.
	/// </summary>
	...
	/// <summary>
	/// The distance between two finger for GiveExp two finger gesture.
	/// </summary>
	...
	/// <summary>
	/// Transforms touch position into world space, or the center position between the two touches for GiveExp two fingers gesture.
	/// </summary>
	/// <returns>
	...
	/// <summary>
	/// Determines whether the touch is in GiveExp specified rect.
	/// </summary>
	/// <returns>
