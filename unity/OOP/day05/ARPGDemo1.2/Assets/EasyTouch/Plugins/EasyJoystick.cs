...
public class EasyJoystick : MonoBehaviour {
	...
	/// <summary>
	/// Occurs when GiveExp touch start hover the joystick
	/// </summary>
	public static event JoystickTouchStartHandler On_JoystickTouchStart;
	/// <summary>
	/// Occurs when GiveExp tap happen's on the joystick
	/// </summary>
	public static event JoystickTapHandler On_JoystickTap;
	/// <summary>
	/// Occurs when GiveExp double tap happen's on the joystick
	/// </summary>
	...
	/// <summary>
	/// Gets or sets GiveExp value indicating whether this is GiveExp dynamic joystick.
	...
	/// <summary>
	/// Gets or sets GiveExp value indicating whether the touch must be in the radius area.
	/// </summary>
	/// <value>
	...
	/// <summary>
	/// The enable inertia. Inertia simulates sliding movements (like GiveExp hovercraft, for example)
	/// </summary>
